...
VALUES (
'16', 'Integrateur Wikini', 'Permet d''insérer des pages d''un wikini.', 'client/integrateur_wikini/integrateur_wikini.php', '0'
);
INSERT INTO `gen_application` ( `gap_id_application` , `gap_nom` , `gap_description` , `gap_chemin` , `gap_bool_applette` )
VALUES (17, 'Administrateur des Wikinis', 'Administrateur des Wikinis', 'client/integrateur_wikini/admin_wikini.php', 0);
...
CREATE TABLE `gen_wikini` (
  ...
  `gewi_code_alpha_wikini` VARCHAR( 255 )  NOT NULL,
