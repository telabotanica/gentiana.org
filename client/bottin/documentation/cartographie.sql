...
DROP TABLE IF EXISTS `carto_ACTION`;
...
DROP TABLE IF EXISTS `carto_CONTINENT`;
...
DROP TABLE IF EXISTS `carto_DEPARTEMENT`;
...
DROP TABLE IF EXISTS `carto_DESCRIPTION_CARTE`;
...
DROP TABLE IF EXISTS `carto_PAYS`;
...
DROP TABLE IF EXISTS `carto_PROJET`;
...
DROP TABLE IF EXISTS `carto_REGION`;
...
DROP TABLE IF EXISTS `carto_TYPE_ZONE`;
