...
// CVS : $Id$
/**
* Interface DAO pour PublicationCategorie
*
* Description
*
*@package eFlore
...
interface iDaoEpuca {
	...
	* 
	* @param PublicationCategorie l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param PublicationCategorie l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param PublicationCategorie l'objet contenant les valeurs à modifier.
