...
// CVS : $Id$
/**
* Interface DAO pour NomComposerCommentaire
*
* Description
*
*@package eFlore
...
interface iDaoEncc {
	...
	* 
	* @param NomComposerCommentaire l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param NomComposerCommentaire l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param NomComposerCommentaire l'objet contenant les valeurs à modifier.
