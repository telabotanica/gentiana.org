...
// CVS : $Id$
/**
* Interface DAO pour StructureValeur
*
* Description
*
*@package eFlore
...
interface iDaoEsv {
	...
	* 
	* @param StructureValeur l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param StructureValeur l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param StructureValeur l'objet contenant les valeurs à modifier.
