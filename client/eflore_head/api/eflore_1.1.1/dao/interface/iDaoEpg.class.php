...
// CVS : $Id$
/**
* Interface DAO pour PersonneGroupe
*
* Description
*
*@package eFlore
...
interface iDaoEpg {
	...
	* 
	* @param PersonneGroupe l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param PersonneGroupe l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param PersonneGroupe l'objet contenant les valeurs à modifier.
