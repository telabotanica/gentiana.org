...
// CVS : $Id$
/**
* Interface DAO pour ChorologieTypeNotion
*
* Description
*
*@package eFlore
...
interface iDaoEctn {
	...
	* 
	* @param ChorologieTypeNotion l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param ChorologieTypeNotion l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param ChorologieTypeNotion l'objet contenant les valeurs à modifier.
