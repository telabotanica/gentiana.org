...
// CVS : $Id$
/**
* Interface DAO pour NomCitationPosseder
*
* Description
*
*@package eFlore
...
interface iDaoEncp {
	...
	* 
	* @param NomCitationPosseder l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param NomCitationPosseder l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param NomCitationPosseder l'objet contenant les valeurs à modifier.
