...
interface iDaoEzr {
	...
	/** Récupère toutes les données des zg de type "Code officiel supprimé" pour un groupe de zg et un projet donnés.*/
	const CONSULTER_GROUPE_ID_CODE_SUPR = 5;
...
*
* $Log$
* Revision 1.2  2007-06-22 16:26:38  jp_milcent
* Ajout de requêtes de consultation.
*
