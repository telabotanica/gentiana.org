...
// CVS : $Id$
/**
* Interface DAO pour ChorologieIntituleNotion
*
* Description
*
*@package eFlore
...
interface iDaoEcin {
	...
	* 
	* @param ChorologieIntituleNotion l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param ChorologieIntituleNotion l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param ChorologieIntituleNotion l'objet contenant les valeurs à modifier.
