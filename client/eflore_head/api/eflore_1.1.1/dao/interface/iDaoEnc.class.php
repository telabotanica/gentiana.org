...
// CVS : $Id$
/**
* Interface DAO pour NomCategorie
*
* Description
*
*@package eFlore
...
interface iDaoEnc {
	...
	* 
	* @param NomCategorie l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param NomCategorie l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param NomCategorie l'objet contenant les valeurs à modifier.
