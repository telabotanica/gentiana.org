...
// CVS : $Id$
/**
* Interface DAO pour InfoImageValeur
*
* Description
*
*@package eFlore
...
interface iDaoEiiv {
	...
	* 
	* @param InfoImageValeur l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param InfoImageValeur l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param InfoImageValeur l'objet contenant les valeurs à modifier.
