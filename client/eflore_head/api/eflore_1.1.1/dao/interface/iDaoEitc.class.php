...
// CVS : $Id$
/**
* Interface DAO pour InfoTxtCategorie
*
* Description
*
*@package eFlore
...
interface iDaoEitc {
	...
	* 
	* @param InfoTxtCategorie l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param InfoTxtCategorie l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param InfoTxtCategorie l'objet contenant les valeurs à modifier.
