...
// CVS : $Id$
/**
* Interface DAO pour InfoImageRelation
*
* Description
*
*@package eFlore
...
interface iDaoEiir {
	...
	* 
	* @param InfoImageRelation l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param InfoImageRelation l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param InfoImageRelation l'objet contenant les valeurs à modifier.
