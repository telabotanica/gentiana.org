...
// CVS : $Id$
/**
* Interface DAO pour InfoImageCategorie
*
* Description
*
*@package eFlore
...
interface iDaoEiic {
	...
	* 
	* @param InfoImageCategorie l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param InfoImageCategorie l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param InfoImageCategorie l'objet contenant les valeurs à modifier.
