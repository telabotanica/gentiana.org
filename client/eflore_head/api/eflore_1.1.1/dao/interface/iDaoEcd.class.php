...
interface iDaoEcd {
	...
	/** Récupère toutes les données pour un taxon et un projet choro donné.*/
	const CONSULTER_VERSION_CHORO_TAXON = 5;
	/** Récupère toutes les zones géographiques pour un projet de taxon et un projet choro donné.*/
	const CONSULTER_ZG_CHORO_VERSION = 6;
	/** Récupère tous les projets choro pour un projet de taxon donné.*/
	const CONSULTER_PROJET_CHORO_VERSION = 7;
	/** Récupère tous les taxons pour une zone géographique et un projet choro donné.*/
	const CONSULTER_TAXON_PAR_ZG_ET_PROJET_CHORO = 8;
	/** Récupère le nombre de taxons pour une zone géographique et un projet choro donné.*/
	const CONSULTER_NBRE_TAXON_PAR_ZG_ET_PROJET_CHORO = 9;
	/** Récupère toutes les infos pour un projet choro donné.*/
