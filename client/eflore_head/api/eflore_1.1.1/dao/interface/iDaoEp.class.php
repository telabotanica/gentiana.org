...
interface iDaoEp {
	...
	* 
	* @param Personne l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param Personne l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param Personne l'objet contenant les valeurs à modifier.
