...
// CVS : $Id$
/**
* Interface DAO pour ChorologieDonneeAContributeur
*
* Description
*
*@package eFlore
...
interface iDaoEcdac {
	...
	* 
	* @param ChorologieDonneeAContributeur l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param ChorologieDonneeAContributeur l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param ChorologieDonneeAContributeur l'objet contenant les valeurs à modifier.
