...
// CVS : $Id$
/**
* Interface DAO pour DroitCreerProjet
*
* Description
*
*@package eFlore
...
interface iDaoEdrcp {
	...
	* 
	* @param DroitCreerProjet l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param DroitCreerProjet l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param DroitCreerProjet l'objet contenant les valeurs à modifier.
