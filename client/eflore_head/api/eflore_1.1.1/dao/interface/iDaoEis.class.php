...
// CVS : $Id$
/**
* Interface DAO pour InventaireStation
*
* Description
*
*@package eFlore
...
interface iDaoEis {
	...
	* 
	* @param InventaireStation l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param InventaireStation l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param InventaireStation l'objet contenant les valeurs à modifier.
