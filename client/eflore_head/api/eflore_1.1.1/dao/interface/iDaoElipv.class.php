...
// CVS : $Id$
/**
* Interface DAO pour LienPossederValeur
*
* Description
*
*@package eFlore
...
interface iDaoElipv {
	...
	* 
	* @param LienPossederValeur l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param LienPossederValeur l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param LienPossederValeur l'objet contenant les valeurs à modifier.
