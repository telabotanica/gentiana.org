...
// CVS : $Id$
/**
* Interface DAO pour VernaculaireAttribution
*
* Description
*
*@package eFlore
...
interface iDaoEva {
	...
	/** Récupère toutes les données pour un conseil d'emploi et un groupe de taxon.*/
	const CONSULTER_EMPLOI_PROJET_TAXON_GROUPE_ID = 5;
