...
class ChorologieDonneeACitationSqlDao extends aDaoSqlEflore implements iDaoEcdaci {
	...
	* 
	* @param ChorologieDonneeACitation l'objet contenant les valeurs à ajouter.
	...
	* 
	* @param ChorologieDonneeACitation l'objet contenant les identifiants de la ligne à supprimer.
	...
	* 
	* @param ChorologieDonneeACitation l'objet contenant les valeurs à modifier.
