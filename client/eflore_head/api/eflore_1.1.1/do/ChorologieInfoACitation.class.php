...
// CVS : $Id$
/**
* Classe ChorologieInfoACitation
*
* Description
*
*@package eFlore
...
class ChorologieInfoACitation extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'ChorologieInfoACitation';
	
	/*** Attributes : ***/
	private $notes_info_citation;
	
	/*** Constructeur : ***/
	
	/*** Accesseurs : ***/
	// Notes Info Citation
	public function getNotesInfoCitation()
	{
		return $this->notes_info_citation;
	}
	public function setNotesInfoCitation( $nic )
	{
		$this->notes_info_citation = $nic;
		$this->setMetaAttributsUtilises('notes_info_citation');
	}
