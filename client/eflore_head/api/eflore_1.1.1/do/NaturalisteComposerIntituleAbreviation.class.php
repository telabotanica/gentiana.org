...
// CVS : $Id$
/**
* Classe NaturalisteComposerIntituleAbreviation
*
* Description
*
*@package eFlore
...
class NaturalisteComposerIntituleAbreviation extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'NaturalisteComposerIntituleAbreviation';
