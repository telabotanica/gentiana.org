...
class TaxonATxt extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'TaxonATxt';
	...
	/*** Accesseurs : ***/
	// Notes Taxon A Txt
	public function getNotesTaxonATxt()
	{
		return $this->notes_taxon_a_txt;
	}
	public function setNotesTaxonATxt( $ntat )
	{
		$this->notes_taxon_a_txt = $ntat;
		$this->setMetaAttributsUtilises('notes_taxon_a_txt');
	}
