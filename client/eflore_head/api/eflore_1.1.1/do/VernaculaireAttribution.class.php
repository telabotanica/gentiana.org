...
// CVS : $Id$
/**
* Classe VernaculaireAttribution
*
* Description
*
*@package eFlore
...
class VernaculaireAttribution extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'VernaculaireAttribution';
	
	/*** Attributes : ***/
	private $commentaires_geographiques;
	private $mark_info_biblio;
	private $notes_emploi_nom_vernaculaire;
	...
	public function setCommentairesGeographiques( $cg )
	{
		...
		$this->setMetaAttributsUtilises('commentaires_geographiques');
	}
	...
	public function setMarkInfoBiblio( $mib )
	{
		...
		$this->setMetaAttributsUtilises('mark_info_biblio');
	}
	
	// Notes Emploi Nom Vernaculaire
	public function getNotesEmploiNomVernaculaire()
	{
		return $this->notes_emploi_nom_vernaculaire;
	}
	public function setNotesEmploiNomVernaculaire( $nenv )
	{
		$this->notes_emploi_nom_vernaculaire = $nenv;
		$this->setMetaAttributsUtilises('notes_emploi_nom_vernaculaire');
	}
