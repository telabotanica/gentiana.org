...
class TaxonRelation extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'TaxonRelation';
	
	/*** Attributes : ***/
	private $notes_relation_taxon;
	
	/*** Constructeur : ***/
	
	/*** Accesseurs : ***/
	// Notes Relation Taxon
	public function getNotesRelationTaxon()
	{
		return $this->notes_relation_taxon;
	}
	public function setNotesRelationTaxon( $nrt )
	{
		$this->notes_relation_taxon = $nrt;
		$this->setMetaAttributsUtilises('notes_relation_taxon');
	}
