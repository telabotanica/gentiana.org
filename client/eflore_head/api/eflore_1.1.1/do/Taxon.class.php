...
class Taxon extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'Taxon';
	...
	/*** Accesseurs : ***/
	// Notes Taxon
	public function getNotesTaxon()
	{
		return $this->notes_taxon;
	}
	public function setNotesTaxon( $nt )
	{
		$this->notes_taxon = $nt;
		$this->setMetaAttributsUtilises('notes_taxon');
	}
