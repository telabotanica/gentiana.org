...
class ZgIntitule extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'ZgIntitule';
	
	/*** Attributes : ***/
	private $intitule_zone_geo;
	
	/*** Constructeur : ***/
	
	/*** Accesseurs : ***/
	// Intitule Zone Geo
	public function getIntituleZoneGeo()
	{
		return $this->intitule_zone_geo;
	}
	public function setIntituleZoneGeo( $izg )
	{
		$this->intitule_zone_geo = $izg;
		$this->setMetaAttributsUtilises('intitule_zone_geo');
	}
