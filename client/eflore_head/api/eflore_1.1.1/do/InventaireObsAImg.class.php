...
class InventaireObsAImg extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'InventaireObsAImg';
	
	/*** Attributes : ***/
	private $notes_img_obs;
	
	/*** Constructeur : ***/
	
	/*** Accesseurs : ***/
	// Notes Img Obs
	public function getNotesImgObs()
	{
		return $this->notes_img_obs;
	}
	public function setNotesImgObs( $nio )
	{
		$this->notes_img_obs = $nio;
		$this->setMetaAttributsUtilises('notes_img_obs');
	}
