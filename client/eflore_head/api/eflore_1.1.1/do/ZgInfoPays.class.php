...
class ZgInfoPays extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'ZgInfoPays';
	
	/*** Attributes : ***/
	private $capitale;
	private $annee_independance;
	...
	public function setCapitale( $c )
	{
		$this->capitale = $c;
		$this->setMetaAttributsUtilises('capitale');
	}
	
	// Annee Independance
	public function getAnneeIndependance()
	{
		return $this->annee_independance;
	}
	public function setAnneeIndependance( $ai )
	{
		$this->annee_independance = $ai;
		$this->setMetaAttributsUtilises('annee_independance');
	}
