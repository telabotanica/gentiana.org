...
class NaturalisteAbreviation extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'NaturalisteAbreviation';
	
	/*** Attributes : ***/
	private $abeviation;
	private $notes_abreviation;
	...
	// Notes Abreviation
	public function getNotesAbreviation()
	{
		return $this->notes_abreviation;
	}
	public function setNotesAbreviation( $na )
	{
		$this->notes_abreviation = $na;
		$this->setMetaAttributsUtilises('notes_abreviation');
	}
