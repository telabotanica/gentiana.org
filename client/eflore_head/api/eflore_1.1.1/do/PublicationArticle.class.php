...
class PublicationArticle extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'PublicationArticle';
	...
	public function setPageDebut( $pd )
	{
		$this->page_debut = $pd;
		$this->setMetaAttributsUtilises('page_debut');
	}
	...
	public function setPageFin( $pf )
	{
		$this->page_fin = $pf;
		$this->setMetaAttributsUtilises('page_fin');
	}
