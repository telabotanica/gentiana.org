...
class PublicationCollection extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'PublicationCollection';
	
	/*** Attributes : ***/
	private $intitule_collection;
	...
	/*** Accesseurs : ***/
	// Intitule Collection
	public function getIntituleCollection()
	{
		return $this->intitule_collection;
	}
	public function setIntituleCollection( $ic )
	{
		$this->intitule_collection = $ic;
		$this->setMetaAttributsUtilises('intitule_collection');
	}
	...
	public function setPeriodicite( $p )
	{
		$this->periodicite = $p;
		$this->setMetaAttributsUtilises('periodicite');
	}
