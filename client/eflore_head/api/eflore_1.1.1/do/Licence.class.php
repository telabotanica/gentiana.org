...
class Licence extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'Licence';
	
	/*** Attributes : ***/
	private $intitule_principal;
	private $abreviation;
	private $description;
	private $texte_original;
	private $lien;
	private $notes_licence;
	...
	// Texte Original
	public function getTexteOriginal()
	{
		return $this->texte_original;
	}
	public function setTexteOriginal( $to )
	{
		$this->texte_original = $to;
		$this->setMetaAttributsUtilises('texte_original');
	}
	...
	{
		$this->lien = $l;
		$this->setMetaAttributsUtilises('lien');
	}
	
	// Notes Licence
	public function getNotesLicence()
	{
		return $this->notes_licence;
	}
	public function setNotesLicence( $nl )
	{
		$this->notes_licence = $nl;
		$this->setMetaAttributsUtilises('notes_licence');
	}
