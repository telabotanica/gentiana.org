...
// +------------------------------------------------------------------------------------------------------+
// CVS : $Id: TaxonAProtection.class.php,v 1.2 2007-01-03 17:05:30 jp_milcent Exp $
/**
* Classe TaxonAProtection
*
* Description
*
*@package eFlore
...
class TaxonAProtection extends aDonneesObjet
{
	/*** Constantes : ***/
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'TaxonAProtection';
...
/* +--Fin du code ----------------------------------------------------------------------------------------+
*
* $Log: TaxonAProtection.class.php,v $
