...
class ChorologieNotion extends aDonneesObjet
{
	/*** Constantes : ***/
	// Identifiant du projet des notions de la Phychorologie Départementale
	const PHYTOCHORO_DEP = 13;
	// Identifiant du projet des notions de distribution de la BDNFM
	const BDNFM = 29;
	
	/** Constante définissant le nom de l'objet.*/
	const CLASSE_NOM = 'ChorologieNotion';
	...
	// Code Notion
	public function getCodeNotion()
	{
		return $this->code_notion;
	}
	public function setCodeNotion( $cn )
	{
		$this->code_notion = $cn;
		$this->setMetaAttributsUtilises('code_notion');
	}
...
*
* Revision 1.3  2006/12/18 17:08:01  jp_milcent
* Ajout d'une constante pour récupérer l'id du projet BDNFM.
*
* Revision 1.2  2006/09/05 14:21:18  jp_milcent
