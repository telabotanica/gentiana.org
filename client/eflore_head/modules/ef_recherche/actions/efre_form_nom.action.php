...
// +------------------------------------------------------------------------------------------------------+
// CVS : $Id: efre_form_nom.action.php,v 1.7 2006-05-02 10:01:40 jp_milcent Exp $
/**
* Formulaire de recherche nomenclaturale
*
* Contient le formulaire de recherche nomenclaturale.
*
*@package eflore
...
*@version       $Revision: 1.7 $ $Date: 2006-05-02 10:01:40 $
// +------------------------------------------------------------------------------------------------------+
*/
...
}//Fin classe ActionFormNom()

/* +--Fin du code ----------------------------------------------------------------------------------------+
*
* $Log: efre_form_nom.action.php,v $
...
*
* Revision 1.2  2005/07/28 15:37:56  jp_milcent
