...
require_once(PAP_CHEMIN_API_PEAR.'HTML/Common.php');
...
class HTML_QuickForm extends HTML_Common {
    ...
    {
        include_once(PAP_CHEMIN_API_PEAR.'HTML/QuickForm/RuleRegistry.php');
    ...
    */
    function &defaultRenderer()
    {
        if (!isset($GLOBALS['_HTML_QuickForm_default_renderer'])) {
            include_once(PAP_CHEMIN_API_PEAR.'HTML/QuickForm/Renderer/Default.php');
    ...
    {
        include_once PAP_CHEMIN_API_PEAR.'HTML/QuickForm/Renderer/Array.php';
